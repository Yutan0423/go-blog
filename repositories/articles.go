...
func InsertArticle(db *sql.DB, article models.Article) (models.Article, error) {
	...
	result, err := db.ExecContext(context.Background(), sqlStr, article.Title, article.Contents, article.UserName)
	if err != nil {
...
func SelectArticleList(db *sql.DB, page int) ([]models.Article, error) {
	...
	for rows.Next() {
		...
		rows.Scan(&article.ArticleID, &article.Title, &article.Contents, &article.UserName, &article.NiceNum)
